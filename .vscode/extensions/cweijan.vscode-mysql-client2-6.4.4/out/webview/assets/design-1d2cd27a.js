import{i as O}from"./vscodeInject-d1aa3399.js";import{_ as R,a as C}from"./select-4620f752.js";import{_ as y,a as T}from"./form-e1958efa.js";import{_ as U}from"./dialog-af59178c.js";import{_ as p}from"./checkbox-2767b1db.js";import{u as b}from"./umy-table.common-a2bbba6b.js";import{D as E,c as I,a as W}from"./codeMirror-416cb659.js";import{S as d,d as N,t as L,w as M,E as Y,b as V}from"./stringUtil-06590acf.js";import{i as B}from"./viewUtil-be301156.js";import{d as q,m as g}from"./app-d7121573.js";import{n as $,_ as j}from"./vueConfig-81691177.js";import{s as F,e as v}from"./notify-8d0c981a.js";import{A as x}from"./arrayUtil-ce2724a4.js";import"./scrollbar-fe572d5c.js";import"./index-fb93a5d0.js";import"./focus-34de79c8.js";import"./index-f37b6d04.js";import"./index-f06350f9.js";class A{dropIndex(e,t){throw new Error("Method not implemented.")}showVersion(){return null}showIndex(e,t){return null}createIndex(e){return null}showDatabases(){return null}updateUser(e){return null}showCollations(){return null}showPackages(e){return null}showChecks(e,t){return null}showPartitions(e,t){return null}showActualPartitions(e,t){return null}showForeignKeys(e,t){return null}updateColumnSql(e){throw new Error("Method not implemented.")}showEvents(e){return`SELECT EVENT_NAME "name" FROM information_schema.EVENTS where EVENT_SCHEMA='${e}' ORDER BY EVENT_NAME;`}dropEventTemplate(e){return`DROP EVENT IF EXISTS ${e};`}eventTemplate(){return`CREATE EVENT event_name$1
ON SCHEDULE AT CURRENT_TIMESTAMP + INTERVAL 1 HOUR
DO
BEGIN
    SELECT now()$2;
END;`}pingDataBase(e,t){return null}dropTriggerTemplate(e){return`DROP TRIGGER IF EXISTS ${e}`}}class K extends A{showVersion(){return"select version() server_version"}createIndex(e){const t=e.indexType||"btree";return`CREATE INDEX ${e.column}_${new Date().getTime()}_index ON ${e.table} USING ${t} (${e.column})`}dropIndex(e,t){return`DROP INDEX ${t}`}showIndex(e,t){return`select name index_name,is_in_sorting_key indexdef  FROM system.columns WHERE database = '${e}' and table ='${t}' and indexdef=1`}variableList(){return"select name , value as setting,description from system.settings s "}statusList(){return"select name as db , engine as status from system.databases d "}processList(){return`
...
GRANT ALL PRIVILEGES ON *.* TO 'username'@'%' WITH GRANT OPTION;`}updateUser(e){return`update mysql.user set 
    ...
    where User = '${e}';
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var u;const{name:n,type:r,comment:o,nullable:s,defaultValue:l,extra:i,character_set_name:c,collation_name:m}=t;return new d(`ALTER TABLE ${e}`).append(`
	CHANGE ${n} ${n} ${r}`).if(c,`CHARACTER SET ${c}`).if(m,`COLLATE ${m}`).if(s!="YES","NOT NULL").if((u=i==null?void 0:i.toLowerCase())==null?void 0:u.includes("auto_increment"),"AUTO_INCREMENT").if(o,`COMMENT '${o}'`).if(l,`DEFAULT ${l=="CURRENT_TIMESTAMP"?l:`'${l}'`}`).toString()}updateColumnSql(e){const{table:t,columnName:n,name:r,type:o,isNotNull:s,isAutoIncrement:l,comment:i,defaultValue:c,character_set_name:m,collation_name:u}=e;return new d(`ALTER TABLE "${t}"`).append(`
	CHANGE "${n}" "${r}" ${o}`).if(m,`CHARACTER SET ${m}`).if(u,`COLLATE ${u}`).if(s,"NOT NULL").if(l,"AUTO_INCREMENT").if(i,`COMMENT '${i}'`).if(c,`DEFAULT ${c=="CURRENT_TIMESTAMP"?c:`'${c}'`}`).append(";").toString()}showUsers(){return"SELECT concat(user,'@',host) user FROM mysql.user;"}pingDataBase(e){return e?null:"select 1"}updateTable(e){const{table:t,newTableName:n,comment:r,newComment:o}=e;let s="";return o&&o!=r&&(s=`ALTER TABLE "${t}" COMMENT = '${o}';`),n&&t!=n&&(s+=`ALTER TABLE "${t}" RENAME TO "${n}";`),s}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE "',table_schema,'"."',TABLE_NAME, '";') trun FROM INFORMATION_SCHEMA.TABLES where  table_schema ='${e}' and TABLE_TYPE<>'VIEW';`}createDatabase(e){return"CREATE DATABASE $1;"}showTableSource(e,t){return`SHOW CREATE TABLE "${e}"."${t}";`}showViewSource(e,t){return`SHOW CREATE VIEW  "${e}"."${t}";`}showProcedureSource(e,t){return`SHOW CREATE PROCEDURE "${e}"."${t}";`}showFunctionSource(e,t){return`SHOW CREATE FUNCTION "${e}"."${t}";`}showTriggerSource(e,t){return`SHOW CREATE TRIGGER "${e}"."${t}";`}showColumns(e,t){return`SELECT COLUMN_NAME name,DATA_TYPE simpleType, DATA_TYPE type, IS_NULLABLE nullable 
...
COMMENT ON COLUMN ${e}.${n} IS '${o||""}'`}updateColumnSql(e){const{columnName:t,columnType:n,newColumnName:r,comment:o,defaultValue:s,table:l,isNotNull:i,oldRow:c}=e;return new d("","").if(n!=c.type,`ALTER TABLE "${l}" MODIFY "${t}" ${n};`).if(i!=c.isNotNull,`
ALTER TABLE "${l}" MODIFY "${t}"${i?"NOT NULL":"NULL"};`).if(s!=null&&s!=c.defaultValue,`
ALTER TABLE "${l}" MODIFY "${t}" DEFAULT ${s!=null&&s.match(/(:|nextval)/i)?s:`'${s==null?void 0:s.replace(/(^'|'$)/g,"")}'`};`).if(o&&o!=c.comment,`
...
a.table_name = '${t}'`}showChecks(e,t){return`SELECT
    ...
    where
        ...
        where t.owner='${e}' ORDER BY "name"`}showDatabases(){return'select username as "Database" from sys.all_users order by username'}showSchemas(){return'select username as "Database" from sys.all_users order by username'}tableTemplate(){return`CREATE TABLE table_name$1(  
...
BEGIN 
    $2
    RETURN x*2;
END;`}}class X extends H{showVersion(){return`SELECT REPLACE(banner,'DM Database Server 64 ','') "server_version"  FROM v$version where rownum=1;`}createIndex(e){const{table:t,column:n="$2"}=e;return`CREATE INDEX ${`${t}_${n}`} ON ${t}(${n});`}dropIndex(e,t){return`DROP INDEX ${t};`}showIndex(e,t){return`SELECT COLUMN_NAME "column_name",INDEX_NAME "index_name" from DBA_IND_COLUMNS WHERE TABLE_OWNER='${e}' and TABLE_NAME='${t}';`}variableList(){return"show global VARIABLES"}statusList(){return"show global status"}processList(){return"show processlist"}addColumn(e,t){return`ALTER TABLE ${e} 
    ADD COLUMN $1 $2;
...
where a.object_type = 'TABLE' and a.owner='${e}' and a.TEMPORARY<>'Y';`}showDatabases(){return`select object_name "Database" from all_objects where object_type = 'SCH';`}showSchemas(){return`select object_name "Database" from all_objects where object_type = 'SCH';`}tableTemplate(){return`CREATE TABLE table_name$1(  
...
}`}viewTemplate(){return""}procedureTemplate(){return""}triggerTemplate(){return""}functionTemplate(){return""}}class P extends A{showVersion(){return"select @@version server_version;"}createIndex(e){let t=`${e.type||"key"}`;return t.match(/BTREE/i)&&(t="key"),`ALTER TABLE ${e.table} ADD ${t} (\`${e.column||"$1"}\`)`}dropIndex(e,t){return`ALTER TABLE ${e} DROP INDEX \`${t}\``}showIndex(e,t){return`SELECT column_name "column_name",index_name "index_name",index_type "index_type",non_unique=0 "isUnique" FROM INFORMATION_SCHEMA.STATISTICS WHERE table_schema='${e}' and table_name='${t}';`}variableList(){return"show global VARIABLES"}statusList(){return"show global status"}processList(){return"show processlist"}addColumn(e,t){const n=t?` AFTER \`${t}\``:"";return`ALTER TABLE ${e} 
...
GRANT ALL PRIVILEGES ON *.* TO '$1'@'%' WITH GRANT OPTION;`}updateUser(e){return`update mysql.user set 
    ...
    where User = '${e}';
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var f;const{name:n,type:r,comment:o,nullable:s,defaultValue:l,extra:i,character_set_name:c,collation_name:m,unsigned:u,zerofill:_}=t,h=s!="YES";return new d(`ALTER TABLE ${e}`).append(`
	CHANGE ${n} ${n} ${r}`).if(u=="1","UNSIGNED").if(_=="1","ZEROFILL").if(c,`CHARACTER SET ${c}`).if(m,`COLLATE ${m}`).if(h,"NOT NULL").if((f=i==null?void 0:i.toLowerCase())==null?void 0:f.includes("auto_increment"),"AUTO_INCREMENT").if(o,`COMMENT '${o}'`).if(N(l)&&!h,"DEFAULT NULL").if(!N(l),`DEFAULT ${l=="CURRENT_TIMESTAMP"?l:`'${L(l)}'`}`).toString()}updateColumnSql(e){const{table:t,columnName:n,name:r,type:o,unsigned:s,zerofill:l,isNotNull:i,isAutoIncrement:c,comment:m,defaultValue:u,character_set_name:_,collation_name:h}=e;return new d(`ALTER TABLE \`${t}\``).append(`
	CHANGE \`${n}\` \`${r}\` ${o}`).if(s=="1","UNSIGNED").if(l=="1","ZEROFILL").if(_,`CHARACTER SET ${_}`).if(h,`COLLATE ${h}`).if(i,"NOT NULL").if(c,"AUTO_INCREMENT").if(m,`COMMENT '${m}'`).if(N(u)&&!i,"DEFAULT NULL").if(!N(u),`DEFAULT ${u=="CURRENT_TIMESTAMP"?u:`'${L(u)}'`}`).append(";").toString()}showCollations(){return'select DEFAULT_COLLATE_NAME "name",CHARACTER_SET_NAME "charset",DESCRIPTION "description" from information_schema.CHARACTER_SETS ORDER BY name;'}showChecks(e,t){return`SELECT
...
BEGIN
    $3
    return 0;
END;`}}class z extends P{showVersion(){return"select replace(@@version,'-MariaDB','') server_version;"}}class Z extends A{showVersion(){return"show version"}showDatabases(){return"show dbs"}buildPageSql(e,t,n){return`db('${e}').collection('${t}').find({}).limit(${n}).toArray()`}pingDataBase(e){return null}dropIndex(e,t){throw new Error("Method not implemented.")}updateColumnSql(e){throw new Error("Method not implemented.")}showIndex(e,t){return`db('${e}').collection('${t}').indexes();`}createIndex(e){const{database:t,table:n,column:r}=e;return`db('${t}').collection('${n}').createIndex({ ${r||"column_name"}: 1 });`}showSchemas(){throw new Error("Method not implemented.")}updateTable(e){throw new Error("Method not implemented.")}updateColumn(e,t){throw new Error("Method not implemented.")}showTables(e){throw new Error("Method not implemented.")}addColumn(e,t){throw new Error("Method not implemented.")}showColumns(e,t){throw new Error("Method not implemented.")}showViews(e){throw new Error("Method not implemented.")}showSystemViews(e){throw new Error("Method not implemented.")}showUsers(){throw new Error("Method not implemented.")}createUser(){throw new Error("Method not implemented.")}showTriggers(e){throw new Error("Method not implemented.")}showProcedures(e){throw new Error("Method not implemented.")}showFunctions(e){throw new Error("Method not implemented.")}countSql(e,t){throw new Error("Method not implemented.")}createDatabase(e){return'db("db_name").createCollection("collection")'}truncateDatabase(e){throw new Error("Method not implemented.")}renameTable(e,t,n){throw new Error("Method not implemented.")}showTableSource(e,t){throw new Error("Method not implemented.")}showViewSource(e,t){throw new Error("Method not implemented.")}showProcedureSource(e,t){throw new Error("Method not implemented.")}showFunctionSource(e,t){throw new Error("Method not implemented.")}showTriggerSource(e,t){throw new Error("Method not implemented.")}tableTemplate(){throw new Error("Method not implemented.")}viewTemplate(){throw new Error("Method not implemented.")}procedureTemplate(){throw new Error("Method not implemented.")}triggerTemplate(){throw new Error("Method not implemented.")}functionTemplate(){throw new Error("Method not implemented.")}processList(){throw new Error("Method not implemented.")}variableList(){throw new Error("Method not implemented.")}statusList(){throw new Error("Method not implemented.")}dropTriggerTemplate(e){throw new Error("Method not implemented.")}}class ee extends A{showVersion(){return"SELECT CAST(SERVERPROPERTY('ProductVersion') AS SYSNAME)+' '+CAST(SERVERPROPERTY('Edition') AS SYSNAME) AS server_version"}createIndex(e){return`ALTER TABLE ${e.table} ADD ${e.type} (${e.column})`}dropIndex(e,t){return`DROP INDEX ${e}.${t}`}showIndex(e,t){return`SELECT
        index_name = ind.name,
...
EXEC sp_rename '${e}.${n}', '${n}', 'COLUMN';`}updateColumnSql(e){const{columnName:t,columnType:n,newColumnName:r,comment:o,isNotNull:s,table:l}=e,i=s?"NOT NULL":"NULL";return new d(`ALTER TABLE ${l} ALTER COLUMN ${t} ${n} ${i};`).if(t!=r,()=>`EXEC sp_rename '${l}.${t}' , '${r}', 'COLUMN';`).toString()}showUsers(){return"SELECT name [user] from sys.database_principals where type='S'"}updateTable(e){const{database:t,table:n,newTableName:r}=e;return`sp_rename '${n}', '${r}'`}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE [',table_schema,'].[',TABLE_NAME, '];') trun FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE = 'BASE TABLE'  AND TABLE_SCHEMA='${e}'`}createDatabase(e){return`create database ${e||"[name]"}`}showTableSource(e,t){return""}showViewSource(e,t){return`SELECT definition 'Create View' FROM sys.sql_modules WHERE object_id = OBJECT_ID('${e}.${t}');`}showProcedureSource(e,t){return`SELECT definition 'Create Procedure','${e}.${t}' "Procedure" FROM sys.sql_modules WHERE object_id = OBJECT_ID('${e}.${t}');`}showFunctionSource(e,t){return`SELECT definition 'Create Function','${e}.${t}' "Function" FROM sys.sql_modules WHERE object_id = OBJECT_ID('${e}.${t}');`}showTriggerSource(e,t){return`SELECT definition 'SQL Original Statement','${e}.${t}' "Trigger" FROM sys.sql_modules WHERE object_id = OBJECT_ID('${e}.${t}');`}showColumns(e,t){return["information_schema","sys"].includes(e==null?void 0:e.toLowerCase())?`SELECT
    ...
    ;`}showTriggers(e){return`SELECT t.name TRIGGER_NAME FROM SYS.OBJECTS t INNER JOIN sys.schemas s ON t.schema_id = s.schema_id WHERE TYPE = 'TR' and s.name='${e}'`}showProcedures(e){return`SELECT ROUTINE_NAME FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_SCHEMA = '${e}' and ROUTINE_TYPE='PROCEDURE' ORDER BY ROUTINE_NAME`}showFunctions(e){return`SELECT ROUTINE_NAME FROM INFORMATION_SCHEMA.ROUTINES WHERE SPECIFIC_SCHEMA = '${e}' and ROUTINE_TYPE='FUNCTION' ORDER BY ROUTINE_NAME`}showViews(e){return`SELECT name FROM sys.all_views t where SCHEMA_NAME(t.schema_id)='${e}' order by name`}buildPageSql(e,t,n){return`SELECT TOP ${n} * FROM ${e}.${t};`}countSql(e,t){return`SELECT count(*) count FROM ${e}.${t};`}showTables(e){return`SELECT TABLE_NAME 'name'
      ...
      WHERE
        ...
        AND TABLE_SCHEMA = '${e}' order by TABLE_NAME`}showDatabases(){return"SELECT name 'Database' FROM sys.databases"}showSchemas(){return"SELECT SCHEMA_NAME [schema] FROM INFORMATION_SCHEMA.SCHEMATA"}tableTemplate(){return`CREATE TABLE table_name$1(  
...
COMMENT ON COLUMN ${e}.${n} IS '${o||"comment"}';`}updateColumnSql(e){const{table:t,columnName:n,newColumnName:r,columnType:o,isNotNull:s,isAutoIncrement:l,comment:i,defaultValue:c,oldRow:m}=e,u=c==null?void 0:c.match(/nextval/),_=l&&!m.isAutoIncrement&&!u,h=!l&&m.isAutoIncrement&&!u,f=!l&&m.isAutoIncrement&&u,G=s?"SET NOT NULL":"DROP NOT NULL";return new d(`ALTER TABLE "${t}" ALTER COLUMN "${n}" TYPE ${o};`,`
`).append(`ALTER TABLE "${t}" ALTER COLUMN "${n}" ${G};`).if(_,`ALTER TABLE "${t}" ALTER "${n}" ADD GENERATED ALWAYS AS IDENTITY;`).if(h,`ALTER TABLE "${t}" ALTER "${n}" DROP IDENTITY;`).if(f,`ALTER TABLE "${t}" ALTER COLUMN "${n}" DROP DEFAULT;`).if(!f&&c!=null,`ALTER TABLE "${t}" ALTER COLUMN "${n}" SET DEFAULT ${c!=null&&c.match(/(:|nextval)/i)?c:`'${c}'`};`).if(i&&i!=m.comment,`COMMENT ON COLUMN "${t}"."${n}" is '${i}';`).if(n!=r,`ALTER TABLE "${t}" RENAME COLUMN "${n}" TO "${r}";`).toString()}showUsers(){return'SELECT usename "user" from pg_user '}pingDataBase(e){return e?`set schema '${e}';`:"select 1"}updateTable(e){const{table:t,newTableName:n,comment:r,newComment:o}=e;let s="";return o&&o!=r&&(s=`COMMENT ON TABLE "${t}" IS '${o}';`),n&&t!=n&&(s+=`ALTER TABLE "${t}" RENAME TO "${n}";`),s}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE "',TABLE_NAME, '";') trun FROM INFORMATION_SCHEMA.TABLES WHERE  table_schema ='${e}' AND table_type='BASE TABLE';`}createDatabase(e){return"CREATE DATABASE $1"}showTableSource(e,t){return""}showViewSource(e,t){return`SELECT CONCAT('CREATE VIEW ',table_name,'
AS
...
AND t.table_schema='${e}' order by t.table_name;`}showDatabases(){return'SELECT datname "Database" FROM pg_database WHERE datistemplate = false order by datname ASC;'}showSchemas(){return'select schema_name "schema" from information_schema.schemata order by schema_name ASC;'}tableTemplate(){return`CREATE TABLE table_name$1(  
...
BEGIN
    ...
    return 0;
END;
$$ LANGUAGE plpgsql;`}}class ne extends k{showVersion(){return null}createIndex(e){throw new Error("Redshift not support index!")}dropIndex(e,t){return`DROP INDEX "${t}"`}showIndex(e,t){return`select
    t.relname as table_name,
    i.relname as index_name,
    a.attname as column_name,
    ix.indisprimary "isPrimary",
...
-- change column name
ALTER TABLE ${e} 
    RENAME COLUMN ${n} TO ${n};`}updateColumnSql(e){const{table:t,columnName:n,newColumnName:r,columnType:o,isNotNull:s,isAutoIncrement:l,comment:i,defaultValue:c}=e,m=o,u=s?"SET NOT NULL":"DROP NOT NULL";return new d(`ALTER TABLE "${t}" ALTER COLUMN "${n}" TYPE ${m};`,`
`).append(`ALTER TABLE "${t}" ALTER COLUMN "${n}" ${u};`).if(c!=null,`ALTER TABLE "${t}" ALTER COLUMN "${n}" SET DEFAULT ${c!=null&&c.match(/(:|nextval)/i)?c:`'${c}'`};`).if(i,`COMMENT ON COLUMN "${t}"."${n}" is '${i}';`).if(n!=r,`ALTER TABLE "${t}" RENAME COLUMN "${n}" TO "${r}";`).toString()}showUsers(){return'SELECT usename "user" from pg_user '}pingDataBase(e){return"select 1"}updateTable(e){const{table:t,newTableName:n,comment:r,newComment:o}=e;let s="";return o&&o!=r&&(s=`COMMENT ON TABLE "${t}" IS '${o}';`),n&&t!=n&&(s+=`ALTER TABLE "${t}" RENAME TO "${n}";`),s}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE "',TABLE_NAME, '";') trun FROM INFORMATION_SCHEMA.TABLES WHERE  table_schema ='${e}' AND table_type='BASE TABLE';`}createDatabase(e){return"CREATE DATABASE $1"}showTableSource(e,t){return""}showViewSource(e,t){return`SELECT CONCAT('CREATE VIEW ',table_name,'
AS
(',regexp_replace(view_definition,';$',''),')') "Create View",table_name,view_definition from information_schema.views where table_schema='${e}' and table_name='${t}'
        UNION ALL
        SELECT CONCAT('CREATE MATERIALIZED VIEW ',matviewname,'
...
JOIN pg_catalog.pg_namespace pgn ON pgn.oid=pgc.relnamespace and pgn.nspname=t.table_schema
WHERE t.table_type='BASE TABLE'
AND t.table_schema='${e}' order by t.table_name;`}showDatabases(){return'SELECT datname "Database" FROM pg_database WHERE datistemplate = false order by datname ASC;'}showSchemas(){return'SELECT nspname "schema" from pg_catalog.pg_namespace order by nspname ASC;'}tableTemplate(){return`CREATE TABLE table_name$1(  
...
GRANT ALL PRIVILEGES ON *.* TO '$1'@'%' WITH GRANT OPTION;`}updateUser(e){return`update mysql.user set 
    ...
    where User = '${e}';
FLUSH PRIVILEGES;
-- since mysql version 5.7, password column need change to authentication_string=PASSWORD("newPassword")`}updateColumn(e,t){var _;const{name:n,type:r,comment:o,nullable:s,defaultValue:l,extra:i,character_set_name:c,collation_name:m}=t,u=s!="YES";return new d(`ALTER TABLE ${e}`).append(`
	CHANGE ${n} ${n} ${r}`).if(c,`CHARACTER SET ${c}`).if(m,`COLLATE ${m}`).if(u,"NOT NULL").if((_=i==null?void 0:i.toLowerCase())==null?void 0:_.includes("auto_increment"),"AUTO_INCREMENT").if(o,`COMMENT '${o}'`).if(N(l)&&!u,"DEFAULT NULL").if(!N(l),`DEFAULT ${l=="CURRENT_TIMESTAMP"?l:`'${L(l)}'`}`).toString()}updateColumnSql(e){const{table:t,columnName:n,newColumnName:r,columnType:o,isNotNull:s,isAutoIncrement:l,comment:i,defaultValue:c,oldRow:m}=e,u=`ALTER TABLE "${t}"`,_=s?"SET NOT NULL":"DROP NOT NULL";return new d(`${u} ALTER COLUMN "${n}" TYPE ${o};`,`
`).if(i&&i!=m.comment,`${u} ALTER COLUMN "${n}" COMMENT '${i}';`).if(s!=m.isNotNull,`${u} ALTER COLUMN "${n}" ${_};`).if(n!=r,`${u} RENAME COLUMN "${n}" TO "${r}";`).toString()}showCollations(){return""}showChecks(e,t){return""}showUsers(){return"SELECT user user,host host FROM mysql.user;"}pingDataBase(e,t){return e?`use "${t}"."${e}"`:"select 1"}updateTable(e){const{table:t,newTableName:n,comment:r,newComment:o,collation:s,newCollation:l}=e;let i="";return o&&o!=r&&(i=`ALTER TABLE \`${t}\` COMMENT = '${o}';`),l&&l!=s&&(i+=`ALTER TABLE \`${t}\` collate = '${l}';`),n&&t!=n&&(i+=`ALTER TABLE \`${t}\` RENAME TO \`${n}\`;`),i}truncateDatabase(e){return`SELECT Concat('TRUNCATE TABLE \`',table_schema,'\`.\`',TABLE_NAME, '\`;') trun FROM INFORMATION_SCHEMA.TABLES where  table_schema ='${e}' and TABLE_TYPE<>'VIEW';`}createDatabase(e){return`CREATE DATABASE $1
    DEFAULT CHARACTER SET = 'utf8mb4';`}showTableSource(e,t){return`select get_ddl('table', '${e}.${t}') "Create Table";`}showViewSource(e,t){return`select get_ddl('view', '${e}.${t}') "Create View";`}showProcedureSource(e,t){return`select get_ddl('PROCEDURE', '${e}.${t}()') "Create Procedure";`}showFunctionSource(e,t){return`select get_ddl('FUNCTION', '${e}.${t}()') "Create Function";`}showTriggerSource(e,t){return`SHOW CREATE TRIGGER \`${e}\`.\`${t}\`;`}showColumns(e,t,n){return`SELECT 
        ...
        FROM information_schema.columns c
        WHERE c.table_schema = '${e}' AND c.table_name = '${t}' 
        ORDER BY c.ORDINAL_POSITION;`}showTriggers(e,t){const n=t?` AND EVENT_OBJECT_TABLE='${t}'`:"";return`SELECT TRIGGER_NAME FROM information_schema.TRIGGERS WHERE TRIGGER_SCHEMA = '${e}' ${n} ORDER BY TRIGGER_NAME;`}showProcedures(e){return`SELECT PROCEDURE_NAME ROUTINE_NAME FROM information_schema.PROCEDURES WHERE PROCEDURE_SCHEMA = '${e}' ORDER BY PROCEDURE_NAME`}showFunctions(e){return`SELECT FUNCTION_NAME ROUTINE_NAME FROM INFORMATION_SCHEMA.FUNCTIONS WHERE FUNCTION_SCHEMA='${e}' ORDER BY FUNCTION_NAME`}showViews(e){return`SELECT COMMENT "comment",TABLE_NAME "name",ROW_COUNT "table_rows"
        FROM information_schema.TABLES  WHERE TABLE_SCHEMA = '${e}' and TABLE_TYPE='VIEW' ORDER BY TABLE_NAME;`}buildPageSql(e,t,n){return`SELECT * FROM ${t} LIMIT ${n};`}countSql(e,t){return`SELECT count(*) FROM ${t};`}showTables(e){return`SELECT COMMENT "comment",TABLE_NAME "name",ROW_COUNT "table_rows"
        FROM information_schema.TABLES  WHERE TABLE_SCHEMA = '${e}' and TABLE_TYPE<>'VIEW' ORDER BY TABLE_NAME;`}showDatabases(){return"show databases;"}showSchemas(){return'SELECT SCHEMA_NAME "schema" FROM INFORMATION_SCHEMA.SCHEMATA;'}tableTemplate(){return`CREATE TABLE table_name$1(  
...
$$
    $2return 1;
$$`}}class re extends A{showVersion(){return"select sqlite_version() as server_version"}updateColumn(e,t){throw new Error("SQLite not support update column.")}updateColumnSql(e){throw new Error("SQLite not support update column.")}createIndex(e){const{table:t,column:n="$2"}=e;return`CREATE INDEX ${`${t}_${n}`} ON ${t}(${n});`}showIndex(e,t){return`SELECT name index_name FROM sqlite_master WHERE type='index' and tbl_name='${t}' `}dropIndex(e,t){return`DROP INDEX ${t};`}showSchemas(){throw new Error("Method not implemented.")}showTables(e){return"SELECT name, type FROM sqlite_master WHERE type='table' ORDER BY type ASC, name ASC;"}addColumn(e,t){return`ALTER TABLE ${e} 
...
AS
SELECT * FROM $2`}procedureTemplate(){throw new Error("Method not implemented.")}triggerTemplate(){throw new Error("Method not implemented.")}functionTemplate(){throw new Error("Method not implemented.")}processList(){throw new Error("Method not implemented.")}variableList(){throw new Error("Method not implemented.")}statusList(){throw new Error("Method not implemented.")}}function oe(a){switch(a||(a=E.MYSQL),a){case null:case E.MYSQL:return new P;case E.MARIA_DB:return new z;case E.MSSQL:return new ee;case E.SQLITE:return new re;case E.REDSHIFT:return new ne;case E.SNOWFLAKE:return new ae;case E.PG:return new k;case E.CLICKHOUSE:return new K;case E.DM:return new X;case E.ORACLE:return new H;case E.ES:return new J;case E.MONGO_DB:return new Z;case E.NEO4J:return new te}return new Q}class S{constructor(e){this.meta=e,this.dialect=oe(e.dbType),this.wrappedTable=M(this.meta.table,this.meta.dbType,Y.Always)}updateTable(e){return this.dialect.updateTable(e)}columnTypes(){return["INTEGER",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"hr","TIMESTAMP","DATE","hr","BOOLEAN","FLOAT","DOUBLE","hr","TEXT","JSON","BLOB"]}strategys(){return["RESTRICT","CASCADE","SET NULL","SET DEFAULT","NO ACTION"]}newColumn(e){const{name:t,type:n,isNotNull:r}=e,o=r?" NOT NULL":"";return`ALTER TABLE ${this.wrappedTable} ADD COLUMN ${M(t,this.meta.dbType)} ${n}${o}`}updateColumn(e){return this.dialect.updateColumnSql({...e,table:this.meta.table})}dropColumn(e){return`ALTER TABLE ${this.wrappedTable} DROP COLUMN ${M(e,this.meta.dbType)}`}formatIndexType(e){return e.index_type}indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"}]}dropIndex(e){return this.dialect.dropIndex(this.wrappedTable,e)}showChecks(){return this.dialect.showChecks(this.meta.schema,this.meta.table)}showForeignKeys(){return`SELECT
...
WHERE c.table_schema = '${this.meta.schema}' and c.table_name = '${this.meta.table}' ORDER BY ik.CONSTRAINT_NAME;`}newForeignKey(e){const{column:t,foreignKeyName:n,refTable:r,refColumn:o,onUpdate:s,onDelete:l}=e,i=s=="NO ACTION"?"":` ON UPDATE ${s}`,c=l=="NO ACTION"?"":` ON DELETE ${l}`;return new d(`ALTER TABLE "${this.meta.table}"`).if(n,()=>`ADD CONSTRAINT ${n}`).if(!n,"ADD").append(`FOREIGN KEY ("${t}") REFERENCES "${r}"("${o}")${i}${c};`).toString()}dropForignKey(e){return`ALTER TABLE "${this.meta.table}" DROP CONSTRAINT ${e};`}newCheck(e){return`ALTER TABLE ${this.wrappedTable} ADD CHECK (${e});`}dropCheck(e){return`ALTER TABLE ${this.wrappedTable} DROP CONSTRAINT ${e};`}splitColumn(e,t='"'){return e.map(n=>t+n+t).join(",")}}class se extends S{newIndex(e){const{columns:t}=e;return`ALTER TABLE "${this.meta.table}" ADD INDEX ${t.join("")}_${new Date().getTime()}_index expression TYPE type GRANULARITY value AFTER ${this.splitColumn(t)}`}showForeignKeys(){return null}showChecks(){return null}}class le extends S{newColumn(e){const{name:t,type:n,defaultValue:r,isNotNull:o}=e;return new d(`ALTER TABLE ${M(this.meta.table,this.meta.dbType)} ADD ${M(t,this.meta.dbType)} ${n}`).if(o,"NOT NULL").if(!N(r),`DEFAULT '${L(r)}'`).toString()}newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,o=`${t}_${n.join("_")}_${new Date().getTime()}`;return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${o} ON "${t}"(${this.splitColumn(n)});`}showForeignKeys(){return this.dialect.showForeignKeys(this.meta.schema,this.meta.table)}}class ie extends S{indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"},{label:"FULLTEXT",value:"FULLTEXT"}]}columnTypes(){return["INT",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"hr","DATETIME","TIMESTAMP","DATE","hr","BIT","FLOAT","DOUBLE",{label:"DECIMAL",value:"DECIMAL(10,2)"},"BIGINT","hr","TEXT","JSON","BLOB","hr",{label:"ENUM",value:"ENUM('item')"},{label:"SET",value:"SET('item')"}]}newColumn(e){const{name:t,type:n,comment:r,defaultValue:o,isNotNull:s,unsigned:l,zerofill:i}=e;return new d(`ALTER TABLE ${this.wrappedTable} ADD COLUMN \`${t}\` ${n}`).if(l,"UNSIGNED").if(i,"ZEROFILL").if(s,"NOT NULL").if(r,`COMMENT '${r}'`).if(!N(o),`DEFAULT '${L(o)}'`).toString()}formatIndexType(e){const t=e.index_type.toUpperCase();return t=="BTREE"?e.index_name=="PRIMARY"?"PRIMARY":B(e.isUnique)?"UNIQUE":"KEY":t}newIndex(e){const{type:t="key",columns:n}=e;return`ALTER TABLE \`${this.meta.table}\` ADD ${t} (${this.splitColumn(n,"`")})`}newForeignKey(e){const{column:t,foreignKeyName:n,refTable:r,refColumn:o,onUpdate:s,onDelete:l}=e,i=s=="NO ACTION"?"":` ON UPDATE ${s}`,c=l=="NO ACTION"?"":` ON DELETE ${l}`;return new d(`ALTER TABLE \`${this.meta.table}\``).if(n,()=>`ADD CONSTRAINT ${n}`).if(!n,"ADD").append(`FOREIGN KEY (\`${t}\`) REFERENCES \`${r}\`(\`${o}\`)${i}${c};`).toString()}dropForignKey(e){return`ALTER TABLE \`${this.meta.table}\` DROP FOREIGN KEY ${e};`}}class ce extends S{newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,o=`${t}_${n.join("_")}_${new Date().getTime()}`;return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${o} ON "${t}"(${this.splitColumn(n)})`}newColumn(e){const{name:t,type:n,isNotNull:r,defaultValue:o,comment:s}=e;return new d(`ALTER TABLE ${M(this.meta.table,this.meta.dbType)} ADD ${t} ${n}`).if(!N(o),`DEFAULT '${L(o)}'`).if(r,"NOT NULL").if(s,`;
COMMENT ON COLUMN ${this.wrappedTable}."${t.toUpperCase()}" is '${s}';`).toString()}newForeignKey(e){const{column:t,foreignKeyName:n,refTable:r,refColumn:o,onUpdate:s,onDelete:l}=e,i=s=="NO ACTION"?"":` ON UPDATE ${s}`,c=l=="NO ACTION"?"":` ON DELETE ${l}`,m=n||`${t}_${r}_${o}_fk_${Math.floor(Math.random()*30)}`;return`ALTER TABLE "${this.meta.table}" ADD CONSTRAINT ${m} FOREIGN KEY ("${t}") REFERENCES ${r}(${o})${i}${c};`}showForeignKeys(){var t;let{schema:e}=this.meta;return(e==null?void 0:e.toLowerCase())==((t=this.meta.user)==null?void 0:t.toLowerCase())&&(e=void 0),this.dialect.showForeignKeys(e,this.meta.table)}}class Ee extends S{newColumn(e){const{name:t,type:n,comment:r,defaultValue:o,isNotNull:s}=e,l=this.wrappedTable;return new d(`ALTER TABLE ${l} ADD COLUMN "${t}" ${n}`).if(s,"NOT NULL").if(!N(o),`DEFAULT '${L(o)}'`).append(";").if(r,`COMMENT ON COLUMN ${l}."${t}" is '${r}';`).toString()}columnTypes(){return["INTEGER",{label:"VARCHAR",value:"VARCHAR(255)"},{label:"CHAR",value:"CHAR(50)"},"TIMESTAMP","DATE","BOOLEAN","FLOAT","TEXT","JSON","BLOB"]}indexTypes(){return[{label:"INDEX",value:"INDEX"},{label:"UNIQUE",value:"UNIQUE"},{label:"HASH",value:"HASH"}]}newIndex(e){const{table:t=this.meta.table,columns:n,type:r}=e,o=r=="HASH"?"hash":"btree";return`CREATE ${r=="UNIQUE"?"UNIQUE":""} INDEX ${n.join("_")}_${new Date().getTime()}_index ON "${t}" USING ${o} (${this.splitColumn(n)});`}showForeignKeys(){return`SELECT
  ...
  GROUP BY
      ...
      ccu.table_schema,
      ccu.table_name
  ORDER BY ord_position;`}}class ue extends S{newIndex(e){throw new Error("Method not implemented.")}dropForignKey(e){return`ALTER TABLE "${this.meta.table}" DROP CONSTRAINT "${e}";`}showForeignKeys(){return`select
